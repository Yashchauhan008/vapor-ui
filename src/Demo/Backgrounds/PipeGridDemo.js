    ...
    <>
      <div className="demo-box">
        ...
        <div className="states">
          <h3>Customization</h3>
            <p className="mb-4"><span className="bg-gray-800 text-white text-sm py-1 px-3 rounded-md mr-2">Note</span>: Please modify grid size after changing dot or ring size.</p>
          {/* Customization UI */}
          <div className="customization-box">
            <div className="customization-item">
              <label htmlFor="dot-size" className="block text-gray-300 mb-2">Dot Size:</label>
              <div className="flex items-center">
                ...
                />
                <span className="bg-gray-800 text-white text-sm py-1 px-3 rounded-md min-w-8 text-center">{dotSize}px</span>
              </div>
            </div>

            <div className="customization-item">
              <label htmlFor="ring-size" className="block text-gray-300 mb-2">Ring Size:</label>
              <div className="flex items-center">
                <input
                  type="range"
                  id="ring-size"
                  ...
                  className="mr-3 w-full range1"
                />
                <span className="bg-gray-800 text-white text-sm py-1 px-3 rounded-md min-w-8 text-center">{ringSize}px</span>
              </div>
            </div>

            <div className="customization-item">
              <label htmlFor="grid-size" className="block text-gray-300 mb-2">Grid Size:</label>
              <div className="flex items-center">
                <input
                  type="range"
                  id="grid-size"
                  ...
                  className="mr-3 w-full range1"
                />
                <span className="bg-gray-800 text-white text-sm py-1 px-3 rounded-md min-w-8 text-center">{gridSize}px</span>
              </div>
            </div>

            <div className="customization-item">
              <label htmlFor="animation-duration" className="block text-gray-300 mb-2">Animation Duration:</label>
              <div className="flex items-center">
                <input
                  type="range"
                  ...
                  className="mr-3 w-full range1"
                />
                <span className="bg-gray-800 text-white text-sm py-1 px-3 rounded-md min-w-8 text-center">{animationDuration}s</span>
              </div>
            </div>
          </div>
