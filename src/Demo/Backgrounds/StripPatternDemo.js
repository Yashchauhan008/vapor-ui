        ...
        <div className="preview-box flex justify-content-center gap-3 p-10">
          ...
          >
            <div className="flex items-center justify-center h-[500px]">
              <h1 className="text-white backdrop:filter blur-0 font-bold text-[60px]">
                {title}
              </h1>
            </div>
          </StripPattern>
        ...
        <div className="states">
          ...
          <div className="customization-box space-y-6">
            <div className="customization-item">
              ...
              <input type="text" id="title" value={title} onChange={(e) => setTitle(e.target.value)} className="mt-2 p-2 rounded-md bg-gray-800 text-white" />
            </div>
          <div className="customization-item">
              <label htmlFor="font-size" className="block text-white mb-2">Strip Width:</label>
              <div className="flex items-center">
                <input
                  ...
                  max="50"
                  step="0.1"
                  value={parseFloat(stripWidth)}
                  onChange={(e) => setStripWidth(Number(e.target.value))}
                  className="mr-3 w-full range1"
                />
                <span className="bg-gray-800 text-white text-sm py-1 px-3 rounded-md min-w-8 text-center">{parseFloat(stripWidth)}rem</span>
              </div>
            </div>
