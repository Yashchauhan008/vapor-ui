export const MagicWandRevealCode= {
    installation:"",
    imports:`import img1 from "../../path/to/img.jpg"
import img2 from "../../path/to/img.jpg"
import img3 from "../../path/to/img.jpg"`,
    parameters:"",
    usage:`<MagicWandReveal
    imageUrls={[
      img1,
      img2,
      img3
