...
export default function CardStack({ image, title, subtitle, cardNumber }) {
  ...
  return (
    ...
    >
      ...
      <div 
        className={
          "absolute inset-0 w-full h-full bg-white rounded shadow-md transition-all duration-500 " +
      ...
      <div className="absolute inset-0 w-full h-full bg-white rounded shadow-md z-10">
        ...
        <div 
          className={
            "absolute inset-x-2.5 top-2.5 bg-gray-900 z-10 transition-all duration-500 " +
        ...
        <div className="absolute inset-x-2.5 bottom-2.5 h-14 z-20">
          <h2 className={
            "mt-1 font-black text-lg text-gray-900 text-center leading-tight " +
