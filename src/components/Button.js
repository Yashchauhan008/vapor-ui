...
const Button = () => {
  ...
  return (
    <button className="group relative dark:bg-neutral-800 bg-neutral-200 rounded-full p-px overflow-hidden" onClick={handleClick}>
